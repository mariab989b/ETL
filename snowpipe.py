...
def save_to_snowflake(snow, batch, temp_dir, ingest_manager):
    ...
    pandas_df = pd.DataFrame(batch, columns=["TXID","RFID","ITEM","SIZE","CATEGORY","GENDER","SUB_CATEGORY","PRICE","PURCHASE_TIME","DELIVERY_TIME", "EXPIRATION_TIME","DAYS","REFUNDED", "REFUND_REASON", "REVIEW_SCORE","REVIEW_TEXT","NAME","ADDRESS","PHONE","EMAIL", "EMERGENCY_CONTACT"])
